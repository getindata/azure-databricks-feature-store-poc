...
# MAGIC %md
# MAGIC # Publish feature tables to online store
...
online_store_spec = AzureCosmosDBSpec(
  ...
  container_name="trip_dropoff_features"
)

# Push the feature table to online store.
fs.publish_table("feature_store_taxi_example.trip_dropoff_features", online_store_spec)

# COMMAND ----------

# Publishing 2nd feature table
online_store_spec = AzureCosmosDBSpec(
  account_uri=account_uri,
  write_secret_prefix="kvfeaturestorepoc/cosmosdb-primary-key-write",
  read_secret_prefix="kvfeaturestorepoc/cosmosdb-primary-key-read",
  database_name="online_feature_store_example",
  container_name="trip_pickup_features"
)
fs.publish_table("feature_store_taxi_example.trip_pickup_features", online_store_spec)
